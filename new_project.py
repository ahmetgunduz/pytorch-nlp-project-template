...
# This script initializes new pytorch nlp project with the template files.
...
ignore = [".git", "data", "saved", "new_project.py", "LICENSE", ".flake8", ".DS_Store", ".word_vectors_cache",
